...
enum ChatMessageType { text, image, document, bookingPrompt, slotPicker, confirmation }
...
class ChatMessageModel {
  ...
  static ChatMessageModel bookingPrompt() => ChatMessageModel(
        id: DateTime.now().millisecondsSinceEpoch.toString(),
        text: '',
        isUser: false,
        timestamp: DateTime.now(),
        type: ChatMessageType.bookingPrompt,
      );
